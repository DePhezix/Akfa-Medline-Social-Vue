...
<template><section class="max-2xl:min-[1245px]:items-center max-2xl:w-full max-2xl:overflow-x-hidden max-2xl:bg-center flex w-[1280px] flex-col gap-[60px] mb-[60px]">
      <div class="max-2xl:w-full max-md:flex max-md:items-end max-md:justify-center max-md:w-full max-md:rounded-[12px] max-md:p-[16px] max-md:pt-[24px] max-md:pb-[24px] max-md:h-[526px] w-[1280px] h-[685px] relative text-white">
        <div class="max-md:static flex flex-col w-[617px] absolute top-[308px] left-[60px] gap-[32px] z-10">
          <header class="flex flex-col gap-[16px]">
            <h2 class="max-md:text-[32px] max-md:leading-[40px] max-md:h-min max-md:w-full max-md:mb-28px w-[473px] h-[135px] text-[56px] leading-[67.2px] tracking-[-1px] font-[400]">{{content[currentLan].header}}</h2>
            <p class="max-md:leading-[1.75rem] max-md:text-[1.25rem] max-md:w-full max-md:font-[500]  font-[500] text-[20px] leading-[150%] tracking-[-0.5px] w-[498px]">{{content[currentLan].subtitle}}</p>
          </header>
          <RouterLink
            smooth
            :to="
